            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="form-group row">
                            <label for="roles" class="col-md- col-form-label text-md-right">Roles</label>

                            <div class="col-md-6">
                                @foreach($roles as $role)
                                <div class="form-check">
                                    <input type="checkbox" name="roles[]" value="{{ $role->id }}" id="" @if($user->roles->pluck('id')->contains($role->id)) checked @endif>
